...
st.subheader("SQL")
st.markdown("Обработка таблицы, сортировка по значениям определенного столбца и получение двух новых из нее в отдельном приложенном ipynb-файле.")
