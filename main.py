...
with st.echo(code_location='below'):
    ...
    st.image("https://img.championat.com/s/735x490/news/big/m/a/kakie-knigi-chitat-v-doroge_1649771640842518832.jpg", width = 100)
    ...
    st.subheader("SQL")
    st.markdown("Обработка таблицы, сортировка по значениям определенного столбца и получение двух новых из нее в отдельном приложенном ipynb-файле, который называется sql_data.ipynb. Но для удобства я еще приложу этот код после основного кода.")
