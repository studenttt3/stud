...
if(which_bs == "Наибольшая концентрация книжных магазинов"):
    ...
    ax.vlines(x = bs1['City'], ymin = 0, ymax= bs1['Figure'], color='darkseagreen', alpha=0.7, linewidth=2)
    ax.scatter(x= bs1['City'], y = bs1['Figure'], s=75, color='darkseagreen', alpha=0.7)
    st.pyplot(fig)
