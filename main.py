...
with st.echo(code_location='below'):
    ...
    st.mardown("Пожалуйста, подождите некоторое время, подвисание может происходить из-за загрузки карт с многочисленными метками, но спустя несколько секунд всё будет работать исправно!")
